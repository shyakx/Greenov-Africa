          ...
          <div className="row">
            <div className="col-lg-10 mx-auto text-center fade-in-up">
              ...
              <p className="lead mb-4" style={{ 
                ...
                Pioneering green solutions for a sustainable future. We're committed to
                environmental excellence and innovative eco-friendly technologies.
              </p>
      ...
      <section className="section-padding bg-light">
        <div className="container">
          ...
          <p className="section-subtitle animate-on-scroll animate-on-scroll-delay-1">
            We combine innovation, expertise, and commitment to deliver exceptional green solutions
          </p>
          <div className="row g-4">
            ...
            height: '80px',
                ...
                <p className="text-muted mb-0">
                  Environmentally friendly solutions that reduce carbon footprint and promote
                  sustainability.
                </p>
              </div>
            </div>
            ...
            height: '80px',
                ...
                <p className="text-muted mb-0">
                  Cutting-edge technologies and innovative approaches to green energy and
                  sustainability.
                </p>
              </div>
            </div>
            ...
            height: '80px',
                ...
                <p className="text-muted mb-0">
                  Dedicated professionals with years of experience in environmental solutions
          ...
          <div className="row">
            <div className="col-lg-8 mx-auto text-center">
              ...
              <p className="lead mb-4 animate-on-scroll animate-on-scroll-delay-1" style={{ 
                ...
                Join us in creating a sustainable future. Let's work together to build a
                greener tomorrow.
              </p>
